...
- When a user provides a website URL and wants ANY kind of video → invoke `/website-to-hyperframes` which captures the site, extracts the design system, and guides you through creating on-brand HyperFrames video compositions.
