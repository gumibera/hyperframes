...
import { fitCaptionFontSize } from "./fitCaptionFontSize.js";
import { prepare, layout } from "@chenglou/pretext";

const mockLayout = vi.mocked(layout);
const mockPrepare = vi.mocked(prepare);

describe("fitCaptionFontSize", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("returns base font size when text fits at base size", () => {
    ...
    const result = fitCaptionFontSize("short text");
  ...
  it("shrinks font size when text wraps at base size", () => {
    ...
    const result = fitCaptionFontSize("this is a much wider piece of text");
  ...
  it("returns minFontSize with fits: false when text never fits", () => {
    ...
    const result = fitCaptionFontSize("WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW");
  ...
  it("respects custom options", () => {
    ...
    const result = fitCaptionFontSize("hello", {
      baseFontSize: 60,
      minFontSize: 30,
      fontWeight: 700,
      fontFamily: "Inter",
