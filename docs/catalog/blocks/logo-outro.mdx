...
<HyperframesPreview src="/registry/blocks/logo-outro/logo-outro.html" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/logo-outro.png" />
