...
<HyperframesPreview src="/registry/blocks/app-showcase/app-showcase.html" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/app-showcase.png" />
